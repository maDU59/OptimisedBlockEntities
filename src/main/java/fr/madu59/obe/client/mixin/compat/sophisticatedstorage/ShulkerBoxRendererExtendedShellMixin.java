...
/** Static-shell interception for Storage 1.5.76--1.5.80's seven-argument body. */
@Mixin(ShulkerBoxRenderer.class)
public abstract class ShulkerBoxRendererExtendedShellMixin {
    @WrapOperation(
            method = "render(Lnet/p3pp3rf1y/sophisticatedstorage/block/ShulkerBoxBlockEntity;FLcom/mojang/blaze3d/vertex/PoseStack;Lnet/minecraft/client/renderer/MultiBufferSource;IIZ)V",
