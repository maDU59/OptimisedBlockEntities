        ...
        if(be instanceof LootrChestBlockEntity lootrChestBe){
            ...
            if (LootrAPI.isVanillaTextures()) {
                ...
                switch (LootrChestType.fromState(state)) {
                    ...
                    case COPPER -> id = ((MultiblockChestResources<SpriteId>)Sheets.CHEST_COPPER.unaffected()).single().texture();
                    case WEATHERED -> id = ((MultiblockChestResources<SpriteId>)Sheets.CHEST_COPPER.weathered()).single().texture();
                    case EXPOSED -> id = ((MultiblockChestResources<SpriteId>)Sheets.CHEST_COPPER.exposed()).single().texture();
                    case OXIDIZED -> id = ((MultiblockChestResources<SpriteId>)Sheets.CHEST_COPPER.oxidized()).single().texture();
